...
&lt;script src="js/analogClock.js"&gt;&lt;/script&gt;
    ...
    &lt;/script&gt;
</code></pre><p data-anchor-id="ywym"> <br>
 <br>
     这是我需要的代码： <br>
         <br>
            AnalogClock("clock1");//simple use <br>
            AnalogClock("clock2", { width: 300, bgColor: "#bf0" });//simple option <br>
            AnalogClock("clock3", new AnalogClockOption(200, "#eee", "#333"));//using option class to customize</p><pre data-anchor-id="pu3d"><code>        //base on object use, returns an clock object, can do some further style controll by the returned object.
        var opt = new AnalogClockOption(); opt.width = 100;
        var clock = new AnalogClock("clock4", opt);
        clock.panel.style.border = "solid 1px red";
    &lt;/script&gt;
